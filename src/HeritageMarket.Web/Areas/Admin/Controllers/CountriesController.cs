...
public class CountriesController : Controller
{
    ...
    public async Task<IActionResult> Create(CountryFormViewModel model)
    {
        ...
        await _countryService.CreateAsync(new CountryDto { Name = model.Name, Code = model.Code, Description = model.Description, FlagImageUrl = model.FlagImageUrl });
    ...
    public async Task<IActionResult> Edit(int id)
    {
        ...
        return View(new CountryFormViewModel { Id = country.Id, Name = country.Name, Code = country.Code, Description = country.Description, FlagImageUrl = country.FlagImageUrl });
    }
    ...
    public async Task<IActionResult> Edit(int id, CountryFormViewModel model)
    {
        ...
        try
        {
            await _countryService.UpdateAsync(new CountryDto { Id = model.Id, Name = model.Name, Code = model.Code, Description = model.Description, FlagImageUrl = model.FlagImageUrl });
